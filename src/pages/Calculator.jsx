...
function Calculator() {
  ...
  function calculate() {
    ...
    if (person !== 0) {
      ...
      console.log(
        `tip ${tipPerPerson} total ${totalPerPerson} total price ${totalPrice}`
      );
    }
  }
  ...
  return (
    <section className="flex max-h-full min-h-screen bg-green-100 ">
      ...
      >
        {/* start of kiri */}
        <div id="kiri" className="flex-initial h-5 h-full text-left">
          {/* start of bill input */}
          <div id="bill" className={styling.title}>
            <h4>Bill</h4>
            <div
              id="inputbar"
              className="flex justify-between px-4 py-2 mt-1 text-2xl bg-gray-100 rounded"
            >
          ...
          <div className="mt-8 " id="Select Tip %">
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
              <button
                ...
                className={
                  `${styling.tipButton}` + (actBtn === 1 ? " active" : "")
                }
              >
                5%
              </button>
              <button
                ...
                className={
                  `${styling.tipButton}` + (actBtn === 2 ? " active" : "")
                }
              >
                10%
              </button>
              <button
                ...
                className={
                  `${styling.tipButton}` + (actBtn === 3 ? " active" : "")
                }
              >
                15%
              </button>
              <button
                ...
                className={
                  `${styling.tipButton}` + (actBtn === 4 ? " active" : "")
                }
              >
                25%
              </button>
              <button
                ...
                className={
                  `${styling.tipButton}` + (actBtn === 5 ? " active" : "")
                }
              >
                50%
              </button>
              ...
              <button
                type="button"
                className={
                  `${styling.tipCustom} px-3` + (actBtn === 6 ? " active" : "")
                }
        ...
        <div id="kanan" className="">
          <div
            className="flex flex-col h-full min-w-full bg-white bg-green-700 w-80 p-9 rounded-2xl"
            id="bg-kanan"
          >
            <div id="teks1">
              <div className="flex justify-between ">
                <div className="min-w-100px">
                  <h4 className="font-bold text-left text-white ">
                    Tip Ammount
                  </h4>
